...
//  PokemonCards
//
//  Created by jazeps.ivulis on 21/04/2023.
//
...
extension PokemonViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "pokemon" {
            guard let destinationVC = segue.destination as? PokemonDetailViewController, let row = tableViewOutlet.indexPathForSelectedRow?.row else { return }
